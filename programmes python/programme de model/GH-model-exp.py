...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 12 11:43:20 2024
...
C_ppl = '/Users/saraguinane/Documents/administratif/stage recherche/starter-pack/purple_filtered_hour_2022_Nan_off-b.csv'
C_ref = '/Users/saraguinane/Documents/administratif/stage recherche/starter-pack/ref_filtered_hour_2022_Nan_off.csv'
...
ppl_filtre_h = ppl[mask_high] * coeff* np.exp(-decay_rate * (temperature_filtre_h - seuil))
...
temperature_filtre = np.concatenate((temperature_filtre_h, temperature_filtre_b))
